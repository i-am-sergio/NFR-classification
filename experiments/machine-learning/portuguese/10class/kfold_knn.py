# -*- coding: utf-8 -*-
"""
kfold_knn.py (Clasificación de 10 Clases)

Este script evalúa un clasificador K-Nearest Neighbors (KNN) en una tarea de
...
5.  DENTRO DEL BUCLE (para cada pliegue):
    ...
    b. Entrena un nuevo modelo KNN en 9 pliegues escalados.
...
print("--- Iniciando Pipeline: 10-Fold CV con K-Nearest Neighbors (KNN) (Clasificación de 10 Clases) ---")
...
for fold, (train_index, test_index) in enumerate(skf.split(X, y_numeric)):
    ...
    # Paso Adicional y Crucial: Escalado de Características
...
# ----------------------------------------
print(f"\n{'='*30} RESULTADOS FINALES AGREGADOS (KNN - 10 CLASES) {'='*30}")
...
plt.title('Matriz de Confusión Agregada (KNN - 10 Clases, 10-Fold CV)')
