# -*- coding: utf-8 -*-
"""
kfold_lr.py (Clasificación de 10 Clases)

Este script evalúa un clasificador de Regresión Logística (LR) en una tarea de
...
5.  DENTRO DEL BUCLE (para cada pliegue):
    ...
    b. Entrena un nuevo modelo de Regresión Logística en 9 pliegues escalados.
...
print("--- Iniciando Pipeline: 10-Fold CV con Logistic Regression (LR) (Clasificación de 10 Clases) ---")
...
for fold, (train_index, test_index) in enumerate(skf.split(X, y_numeric)):
    ...
    # Escalado de Características (importante para LR)
...
# ----------------------------------------
print(f"\n{'='*30} RESULTADOS FINALES AGREGADOS (LOGISTIC REGRESSION - 10 CLASES) {'='*30}")
...
plt.title('Matriz de Confusión Agregada (Logistic Regression - 10 Clases, 10-Fold CV)')
